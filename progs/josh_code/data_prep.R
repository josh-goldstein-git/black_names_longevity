...
nicknames_mpc <- fread("~/Documents/research/black_names_longevity/data/mpc_nicknames.csv")

## do a couple of manual fixes ED, EDDIE --> EDWARD; MOSE --> MOSES

new_nicknames = data.table(fname = c("ED", "EDDIE", "MOSE"),
                           fname_std = c("EDWARD", "EDWARD", "MOSES"),
                           nickname_mpc = c(1,1,1),
                           sex = c(1,1,1))
nicknames.dt = rbind(nicknames_mpc, new_nicknames)

## josh's named vector trick
## we have a vector with observed names as labels and standardized names as values
male_nickname.vec = nicknames.dt[sex == 1]$fname_std
names(male_nickname.vec) = nicknames.dt[sex == 1]$fname
...
## "WILLIAM" "WILLIAM" "WILLIAM" "WILLIAM" "WILLIAM" "WILLIAM" "WILLIAM" "WILLIAM"
##    WILLIM     WILIE   WILLAIM    BILLEY    WILLEM       WIL     WILLA       WLM
## "WILLIAM" "WILLIAM" "WILLIAM" "WILLIAM" "WILLIAM" "WILLIAM" "WILLIAM" "WILLIAM"
##   WILLIUM      WILM      WILH  WILLILAM    WILHAM
...
fwrite(x = dt, file = "./cuny_data.csv")
