...
ggsave(plot = bni_standardized_pyramid, filename = "../figures/bni_pyramid_standardized.pdf", height = 6, width = 9)
```
...
ggsave(plot = scatterplot_adjusted, filename = "../figures/scatterplot_adjusted.png", height = 6, width = 9)
