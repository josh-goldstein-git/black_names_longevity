...
```{r}
bni.add.sibs = feols(death_age ~ bni_std | family + birth_order + byear,  data = additional_sibs, nthreads = 1)
bni.exact.sibs = feols(death_age ~ bni_std | family + birth_order + byear,  data = exact_sibs, nthreads = 1)
bni.all.sibs = feols(death_age ~ bni_std | family + birth_order + byear,  data = all_sibs, nthreads = 1)

etable(bni.add.sibs, bni.exact.sibs, bni.all.sibs, tex = T)
```
