...
m.fe.nick.old = update(m.fe,  death_age ~ bni_root + nick | as.factor(byear))
...
#  ------------------------------------------------------------------------------------------------------------------------------
#  bni_root                 -0.438            -0.419           -0.928**           -0.419           -2.145*           -0.508      
#                           (0.297)           (0.297)           (0.465)           (0.297)          (1.197)           (0.499)     
#                                                                                                                                
#  nickname_mpc                               -0.279*                             -0.279*                           -0.595**     
#                                             (0.156)                             (0.156)                            (0.255)     
#                                                                                                                                
#  ------------------------------------------------------------------------------------------------------------------------------
#  Observations             10,015            10,015            10,015            10,015            3,535             3,535      
#  R2                        0.183             0.184             0.672             0.184            0.874             0.077      
#  Adjusted R2               0.181             0.182             0.233             0.182            0.165             0.074      
#  Residual Std. Error 4.931 (df = 9992) 4.931 (df = 9991) 4.773 (df = 4281) 4.931 (df = 9991) 4.622 (df = 535) 4.866 (df = 3522)
#  ==============================================================================================================================
#  Note:                                                                                              *p<0.1; **p<0.05; ***p<0.01
...
## -------------------------------------------------------------------------------------------------------------
## bni_root                 -0.438            -1.123*           -1.127*          -0.928**           -0.419      
##                          (0.297)           (0.587)           (0.587)           (0.465)           (0.297)     
##                                                                                                              
## nickname_mpc                                                 -0.377                              -0.279*     
##                                                              (0.316)                             (0.156)     
##                                                                                                              
## -------------------------------------------------------------------------------------------------------------
## Observations             10,015            176,652           176,652           10,015            10,015      
## R2                        0.183             0.986             0.986             0.672             0.184      
## Adjusted R2               0.181             0.114             0.115             0.233             0.182      
## Residual Std. Error 4.931 (df = 9992) 5.172 (df = 2702) 5.171 (df = 2701) 4.773 (df = 4281) 4.931 (df = 9991)
## =============================================================================================================
## Note:                                                                             *p<0.1; **p<0.05; ***p<0.01
...
m.fe.north.nick = update(m.fe.north,  death_age ~ bni_root + nickname_mpc | as.factor(byear))
...
## ------------------------------------------------------------------------
## bni_root     -2.125***      -0.436          -2.161**         -2.099**   
##               (0.820)       (0.481)          (0.857)         (0.816)    
##                                                                         
## nickname_mpc               -0.979***                                    
##                             (0.308)                                     
##                                                                         
...
## R2             0.719         0.197            0.736           0.722     
## Adjusted R2    0.235         0.192            0.244           0.242     
## ========================================================================
## Note:                                        *p<0.1; **p<0.05; ***p<0.01
## 
## 
...
##  ------------------------------------------------------------------------
##  bni            -0.699      -0.723**          -0.481           -0.676    
##                (0.504)       (0.350)          (0.657)         (0.503)    
##                                                                          
##  nickname_mpc                 0.184                                      
##                              (0.204)                                     
##                                                                          
...
##  R2             0.708         0.178            0.752           0.709     
##  Adjusted R2    0.239         0.175            0.251           0.241     
##  ========================================================================
##  Note:                                        *p<0.1; **p<0.05; ***p<0.01
##  
